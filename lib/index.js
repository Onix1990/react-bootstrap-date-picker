...
exports.default = (0, _createReactClass2.default)({
  ...
  getDefaultProps: function getDefaultProps() {
    ...
    var dateFormat = !language || language === 'en-us' ? 'ММ/ДД/ГГГГ' : 'ДД/ММ/ГГГГ';
    return {
      cellPadding: '5px',
  ...
  makeInputValueString: function makeInputValueString(date) {
    ...
    var separator = this.state ? this.state.separator : this.props.dateFormat.match(/[^А-Я]/)[0];
    if (this.props.dateFormat.match(/ММ.ДД.ГГГ/)) {
      return (month > 9 ? month : '0' + month) + separator + (day > 9 ? day : '0' + day) + separator + date.getFullYear();
    } else if (this.props.dateFormat.match(/ДД.ММ.ГГГ/)) {
  ...
  handleBadInput: function handleBadInput(originalValue) {
    ...
    if (this.props.dateFormat.match(/ММ.ДД.ГГГ/) || this.props.dateFormat.match(/ДД.ММ.ГГГ/)) {
